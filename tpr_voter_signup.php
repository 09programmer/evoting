...
<div class=well well-sm><h3><strong>SIGNUP FORM FOR VOTERS</strong></h3></div>
...
<form method='post' onsubmit='return frm_check()' enctype='multipart/form-data' action="<?php $_SERVER['PHP_SELF']?>">
  ...
  <span class="error"> <?php echo $rollErr;?></span><br>
    <h2><strong>Mobile Number</strong></h2><?php echo ""?><input type="tel" name="mob" value="<?php echo $mob;?>">
  <span class="error"> <?php echo $mobErr;?></span><br>
  <h2><strong>Gender</strong></h2><?php echo ""?>
