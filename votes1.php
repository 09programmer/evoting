...
<div class=well well-sm><h3><strong>CHOOSE CATEGORY</strong></h2></div>	";
...
if($numm>(10))
{
	echo "<div  class='row'><div class='col-md-1'></div><div class='col-md-5'><a href='result.php?class=results&&name=$cname' class='btn3 btn3-primary'>RESULTS</a></div></div><br>";
}
}
