...
if($numm>($arow[0]-10))
{
	echo "<br><br><br><br><div  class='row'><div class='col-md-1'></div><div class='col-md-5'><a href='tpr_result.php?class=results&&name=$cname' class='btn3 btn3-success'>Results</a></div></div>";
}
}
